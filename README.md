...
`component`    | String | Repository component                         | 'main'           | :create
`distribution` | String | Name of distribution repository              | ''               | :create
...
`component`     | String | Component name to publish                       | ['main']         | :create
...
NOTE2: if you want to use Policyfile, rename `Policyfile.rb.dist` to `Policyfile.rb` in root and test directories, then execute `chef update` in each folder. Look inside `.kitchen.yml` too.
