...
default['aptly']['tarball']['uri'] = "https://dl.bintray.com/smira/aptly/aptly_#{node['aptly']['version']}_linux_amd64.tar.gz"

default['aptly']['user'] = 'aptly'
default['aptly']['group'] = 'aptly'

default['aptly']['rootDir_path'] = '/opt'
default['aptly']['rootDir'] = "#{node['aptly']['rootDir_path']}/aptly"
